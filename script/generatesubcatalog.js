...
'use strict'
//создание метода генерации футера
...
`
//чтобы правильно расположить subcatalog, находим предыдущий элемент и вставляем после него наш subcatalog
const getSubCatalog = document.querySelector('.catalog')
getSubCatalog.insertAdjacentHTML('afterend', subCatalog)
