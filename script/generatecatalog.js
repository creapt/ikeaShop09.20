...
`
//чтобы правильно расположить catalog, находим предыдущий элемент и вставляем после него наш catalog
const addCatalog = document.querySelector('footer')
addCatalog.insertAdjacentHTML('afterend', mainCatalog)
