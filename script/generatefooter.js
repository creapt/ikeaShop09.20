...
`
//чтобы правильно расположить футер, находим предыдущий элемент и вставляем после него наш футер
const addFooter = document.querySelector('main')
addFooter.insertAdjacentHTML('afterend', footer)
}
//вызов функции
generateFooter()